    ...
    public function up()
    {
        if (!Schema::hasTable('employees')){
            Schema::create('employees', function (Blueprint $table) {
                ...
                $table->integer('days_per_week')->nullable()->default(0);
                $table->integer('total_hours_per_year')->nullable()->default(0);
                $table->integer('rate_per_hour')->nullable()->default(0);
                $table->text('profile_image')->nullable();
                $table->integer('department_id')->index('department_id')->default(0);
                $table->integer('section_id')->index('section_id')->nullable()->default(0);
                $table->integer('designation_id')->index('designation_id')->default(0);
                $table->integer('currentaddress_id')->index('currentaddress_id')->nullable()->default(0);
                $table->integer('permanentaddress_id')->index('permanentaddress_id')->nullable()->default(0);
                $table->integer('educationdetails_id')->index('educationdetails_id')->nullable()->default(0);
