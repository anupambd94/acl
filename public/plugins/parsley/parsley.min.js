window.ParsleyExtend = $.extend(window.ParsleyExtend || {}, {
        asyncValidate: function(a, b) { return "ParsleyForm" === this.__class__ ? this._asyncValidateForm(a, b) : this._asyncValidateField() },
        asyncIsValid: function(a) { return "ParsleyField" === this.__class__ ? this._asyncIsValidField() : this._asyncIsValidForm(a) },
        onSubmitValidate: function(a) { var b = this; return a instanceof $.Event && a.preventDefault(), this._asyncValidateForm(void 0, a).done(function() { b.$element.off("submit.Parsley").trigger($.Event("submit")) }) },
        eventValidate: function(a) { new RegExp("key").test(a.type) && !this._ui.validationInformationVisible && this.getValue().length <= this.options.validationThreshold || (this._ui.validatedOnce = !0, this.asyncValidate()) },
        _asyncValidateForm: function(a, b) {
            ...
            return $.when.apply($, d).always(function() { $.emit("parsley:form:validated", c) })
        },
        ...
        _asyncValidateField: function() { var a = this; return $.emit("parsley:field:validate", this), this._asyncIsValidField().done(function() { $.emit("parsley:field:success", a) }).fail(function() { $.emit("parsley:field:error", a) }).always(function() { $.emit("parsley:field:validated", a) }) },
        _asyncIsValidField: function() { var a = $.Deferred(); return !1 === this.isValid() ? a.rejectWith(this) : -1 !== this.indexOfConstraint("remote") ? this._remote(a) : a.resolveWith(this), a.promise() },
        _remote: function(a) {
            var b, c = {},
                d = this,
                e = this.getValue(),
        ...
        _handleRemoteResult: function(a, b, c) { return this._remote[c] = a, "undefined" != typeof this.options.remoteReverse && !0 === this.options.remoteReverse && (a = !a), a ? void b.resolveWith(this) : (this.validationResult = [new window.ParsleyValidator.Validator.Violation(this.constraints[this.indexOfConstraint("remote")], this.getValue(), null)], void b.rejectWith(this)) }
    }), window.ParsleyConfig = $.extend(window.ParsleyConfig || {}, { validators: { remote: { fn: function() { return !0 }, priority: -1 } } }),
    /*!
     * Parsleyjs
    ...
    function(a, b) {
        var c = {
                ...
                dasherize: function(a) { return a.replace(/::/g, "http://pampersdry.info/").replace(/([A-Z]+)([A-Z][a-z])/g, "$1_$2").replace(/([a-z\d])([A-Z])/g, "$1_$2").replace(/_/g, "-").toLowerCase() }
            },
            ...
            e = function() {};
        e.prototype = {
                actualizeOptions: function() { return this.options = this.parsleyInstance.OptionsFactory.get(this), this },
                validateThroughValidator: function() { return a.ParsleyValidator.validate.apply(a.ParsleyValidator, arguments) },
            ...
            function(a) {
                var b = function(a) { return this.__class__ = "Validator", this.__version__ = "0.5.5", this.options = a || {}, this.bindingKey = this.options.bindingKey || "_validatorjsConstraint", this };
                b.prototype = {
                    constructor: b,
                ...
                var c = function(a, b) {
                    if (this.__class__ = "Constraint", this.options = b || {}, this.nodes = {}, a) try { this._bootstrap(a) } catch (c) { throw new Error("Should give a valid mapping object to Constraint", c, a) }
                    return this
                };
                c.prototype = {
                    constructor: c,
                    ...
                    has: function(a, b) { var b = "undefined" != typeof b ? b : this.nodes; return "undefined" != typeof b[a] },
                ...
                e.prototype = {
                    construct: e,
                    check: function(a, b) { if (!(b && !this.hasGroup(b) || !b && this.hasGroups())) try { return this.validate(a, b) } catch (c) { return c } },
                    ...
                    Callback: function(a) {
                        ...
                        return this.fn = a, this.validate = function(a) {
                            ...
                            if (!0 !== c) throw new d(this, a, { result: c });
                            return !0
                        }, this
                    },
                    Choice: function(a) {
        ...
        var f = function(a, b) { this.__class__ = "ParsleyValidator", this.Validator = Validator, this.locale = "en", this.init(a || {}, b || {}) };
        f.prototype = {
            init: function(a, b) {
                this.catalog = b;
            ...
            addMessage: function(a, c, d) { b === typeof this.catalog[a] && (this.catalog[a] = {}), this.catalog[a][c] = d },
            validate: function() { return (new this.Validator.Validator).validate.apply(new Validator.Validator, arguments) },
            addValidator: function(a, b, c) { return this.validators[a] = function(a) { return $.extend((new Validator.Assert).Callback(b, a), { priority: c }) }, this },
            updateValidator: function(a, b, c) { return addValidator(a, b, c) },
            removeValidator: function(a) { return delete this.validators[a], this },
            getErrorMessage: function(b) { var c; return c = "type" === b.name ? a.ParsleyConfig.i18n[this.locale][b.name][b.requirements] : this.formatMesssage(a.ParsleyConfig.i18n[this.locale][b.name], b.requirements), "" !== c ? c : a.ParsleyConfig.i18n[this.locale].defaultMessage },
            ...
            validators: {
                ...
                pattern: function(a) { return $.extend((new Validator.Assert).Regexp(a), { priority: 64 }) },
                minlength: function(a) { return $.extend((new Validator.Assert).Length({ min: a }), { priority: 30 }) },
                maxlength: function(a) { return $.extend((new Validator.Assert).Length({ max: a }), { priority: 30 }) },
                ...
                min: function(a) { return $.extend((new Validator.Assert).GreaterThanOrEqual(a), { priority: 30 }) },
                max: function(a) { return $.extend((new Validator.Assert).LessThanOrEqual(a), { priority: 30 }) },
                range: function(a) { return $.extend((new Validator.Assert).Range(a[0], a[1]), { priority: 32 }) },
                equalto: function(a) { return $.extend((new Validator.Assert).Callback(function(a, b) { return a === $(b).val() }, a), { priority: 256 }) }
            }
        };
        var g = function() { this.__class__ = "ParsleyUI" };
        g.prototype = {
            ...
            getErrorMessage: function(b, c) { var d = c.name + "Message"; return "undefined" != typeof b.options[d] ? b.options[d] : a.ParsleyValidator.getErrorMessage(c) },
            diff: function(a, b, c) {
                ...
                return { kept: e, added: d, removed: c ? [] : this.diff(b, a, !0).added }
            },
            ...
            _manageClassHandler: function(a) { if ("string" == typeof a.options.classHandler && $(a.options.classHandler).length) return $(a.options.classHandler); var b = a.options.classHandler(a); return "undefined" != typeof b && b.length ? b : "undefined" == typeof a.options.multiple ? a.$element : a.$element.parent() },
            _insertErrorWrapper: function(a) { if ("string" == typeof a.options.errorsContainer && $(a.options.errorsContainer).length) return $(a.options.errorsContainer).append(a._ui.$errorsWrapper); var b = a.options.errorsContainer(a); return "undefined" != typeof b && b.length ? b.append(a._ui.$errorsWrapper) : "undefined" == typeof a.options.multiple ? a.$element.after(a._ui.$errorsWrapper) : a.$element.parent().after(a._ui.$errorsWrapper) },
            actualizeTriggers: function(a) { if (a.$element.off(".Parsley"), !1 !== a.options.trigger) { var b = a.options.trigger.replace(/^\s+/g, "").replace(/\s+$/g, ""); "" !== b && a.$element.on(b.split(" ").join(".Parsley ") + ".Parsley", !1, $.proxy("function" == typeof a.eventValidate ? a.eventValidate : this.eventValidate, a)) } },
            ...
            manageFailingFieldTrigger: function(a) { return a._ui.failedOnce = !0, a.options.multiple && $("[" + a.options.namespace + 'multiple="' + a.options.multiple + '"]').each(function() { return new RegExp("change", "i").test($(this).parsley().options.trigger || "") ? void 0 : $(this).parsley().$element.on("change.ParsleyFailedOnce", !1, $.proxy(a.validate, a)) }), new RegExp("keyup", "i").test(a.options.trigger || "") ? void 0 : a.$element.on("keyup.ParsleyFailedOnce", !1, $.proxy(a.validate, a)) },
            reset: function(a) { a.$element.off(".Parsley"), a.$element.off(".ParsleyFailedOnce"), "ParsleyForm" !== a.__class__ && (a._ui.$errorsWrapper.children().each(function() { $(this).remove() }), this._resetClass(a), a._ui.validatedOnce = !1, a._ui.lastValidationResult = [], a._ui.validationInformationVisible = !1) },
            destroy: function(a) { this.reset(a), "ParsleyForm" !== a.__class__ && (a._ui.$errorsWrapper.remove(), delete a._ui) },
        ...
        var h = function(a, b, d, e) { this.__class__ = "OptionsFactory", this.__id__ = c.hash(4), this.formOptions = null, this.fieldOptions = null, this.staticOptions = $.extend(!0, {}, a, b, d, { namespace: e }) };
        h.prototype = {
            get: function(a) {
            ...
            getFormOptions: function(a) { return this.formOptions = c.attr(a.$element, this.staticOptions.namespace), $.extend({}, this.staticOptions, this.formOptions) },
            getFieldOptions: function(a) { return this.fieldOptions = c.attr(a.$element, this.staticOptions.namespace), $.extend({}, this.staticOptions, this.formOptions, this.fieldOptions) }
        };
        var i = function(a, b) {
        ...
        i.prototype = {
            init: function(a) { this.$element = a, this.validationResult = null, this.options = this.parsleyInstance.OptionsFactory.get(this), this.bindFields() },
            onSubmitValidate: function(a) { return this.validate(b, a), !1 === this.validationResult && a instanceof $.Event && a.preventDefault(), this },
            ...
            refreshFields: function() { return this.actualizeOptions().bindFields() },
            bindFields: function() { var a = this; return this.fields = [], this.$element.find(this.options.inputs).each(function() { a.addField(this) }), this },
            addField: function(b) { var c = new a.Parsley(b, {}, this.parsleyInstance); return "ParsleyField" === c.__class__ && this.fields.push(c), this },
            removeField: function() {},
            reset: function() {},
            destroy: function() {}
        };
        var j = function(b, d, e, f, g) { if ("ParsleyField" !== c.get(b, "__class__")) throw new Error("ParsleyField instance expected"); if ("function" != typeof a.ParsleyValidator.validators[d] && "Assert" !== a.ParsleyValidator.validators[d](e).__parentClass__) throw new Error("Valid validator expected"); var h = function(b, d) { return "undefined" != typeof b.options[d + "Priority"] ? b.options[d + "Priority"] : c.get(a.ParsleyValidator.validators[d](e), "priority", 2) }; return f = f || h(b, d), $.extend(a.ParsleyValidator.validators[d](e), { name: d, requirements: e, priority: f, groups: [f], isDomConstraint: g || c.attr(b.$element, b.options.namespace, d) }) },
            k = function(a, b) {
        ...
        k.prototype = {
            init: function(a) { this.constraints = [], this.$element = a, this.validationResult = [], this.options = this.parsleyInstance.OptionsFactory.get(this), this.$element.is("input[type=radio], input[type=checkbox]") && "undefined" == typeof this.options.multiple && (this.options.multiple = this.$element.attr("name").replace(/(:|\.|\[|\]|\$)/g, ""), c.setAttr(this.$element, this.options.namespace, "multiple", this.options.multiple)), this.bindConstraints() },
            validate: function() { return $.emit("parsley:field:validate", this), $.emit("parsley:field:" + (this.isValid() ? "success" : "error"), this), $.emit("parsley:field:validated", this), this.validationResult },
            getConstraintsSortedPriorities: function() { for (var a = [], b = 0; b < this.constraints.length; b++) - 1 === a.indexOf(this.constraints[b].priority) && a.push(this.constraints[b].priority); return a.sort(function(a, b) { return b - a }), a },
            isValid: function() {
            ...
            isRequired: function() { var a = this.indexOfConstraint("required"); return !(-1 === a || -1 !== a && !1 === this.constraints[a].requirements) },
            getValue: function() { if ("undefined" != typeof this.options.value) return this.options.value; if (this.$element.is("input[type=radio]")) return $("[" + this.options.namespace + 'multiple="' + this.options.multiple + '"]:checked').val() || ""; if (this.$element.is("input[type=checkbox]")) { var a = []; return $("[" + this.options.namespace + 'multiple="' + this.options.multiple + '"]:checked').each(function() { a.push($(this).val()) }), a.length ? a : "" } return this.$element.val() },
            refreshConstraints: function() { return this.actualizeOptions().bindConstraints() },
            ...
            addConstraint: function(b, c, d, e) { return b = b.toLowerCase(), "function" == typeof a.ParsleyValidator.validators[b] && (constraint = new j(this, b, c, d, e), -1 !== this.indexOfConstraint(constraint.name) && this.removeConstraint(constraint.name), this.constraints.push(constraint)), this },
        ...
        var l = $({}),
            m = {};
        $.listen = function(a) { if ("undefined" == typeof m[a] && (m[a] = []), "function" == typeof arguments[1]) return m[a].push({ fn: arguments[1] }); if ("object" == typeof arguments[1] && "function" == typeof arguments[2]) return m[a].push({ fn: arguments[2], ctxt: arguments[1] }); throw new Error("Wrong parameters") }, $.listenTo = function(a, b, c) {
        ...
        }, $.unsubscribeAll = function(a) { "undefined" != typeof m[a] && delete m[a] }, $.emit = function(a, b) {
            if ("undefined" != typeof m[a])
                for (var c = 0; c < m[a].length; c++)
                            ...
                            if (m[a][c].instance.__id__ !== b.__id__) {
                                if (m[a][c].instance instanceof i && b instanceof k)
                                    for (var d = 0; d < m[a][c].instance.fields.length; d++)
                                        if (m[a][c].instance.fields[d].__id__ === b.__id__) { m[a][c].fn.apply(l, Array.prototype.slice.call(arguments, 1)); continue }
        ...
        }, $.subscribed = function() { return m }, a.ParsleyConfig = a.ParsleyConfig || {}, a.ParsleyConfig.i18n = a.ParsleyConfig.i18n || {}, a.ParsleyConfig.i18n.en = $.extend(a.ParsleyConfig.i18n.en || {}, { defaultMessage: "This value seems to be invalid.", type: { email: "This value should be a valid email.", url: "This value should be a valid url.", number: "This value should be a valid number.", integer: "This value should be a valid integer.", digits: "This value should be digits.", alphanum: "This value should be alphanumeric." }, notblank: "This value should not be blank.", required: "This value is required.", pattern: "This value seems to be invalid.", min: "This value should be greater than or equal to %s.", max: "This value should be lower than or equal to %s.", range: "This value should be between %s and %s.", minlength: "This value is too short. It should have %s characters or more.", maxlength: "This value is too long. It should have %s characters or less.", length: "This value length is invalid. It should be between %s and %s characters long.", mincheck: "You must select at least %s choices.", maxcheck: "You must select %s choices or less.", check: "You must select between %s and %s choices.", equalto: "This value should be the same." }), "undefined" != typeof a.ParsleyValidator && a.ParsleyValidator.addCatalog("en", a.ParsleyConfig.i18n.en, !0);
        var n = function(a, b, d) { if (this.__class__ = "Parsley", this.__version__ = "2.0.0-rc1", this.__id__ = c.hash(4), "undefined" == typeof a) throw new Error("You must give an element"); return this.init($(a), b, d) };
        n.prototype = {
            init: function(b, e, f) { return this.$element = b, this.$element.data("Parsley") ? this.$element.data("Parsley") : (this.OptionsFactory = new h(d, c.get(a, "ParsleyConfig", {}), e, this.getNamespace(e)), e = this.OptionsFactory.staticOptions, this.$element.is("form") || c.attr(this.$element, e.namespace, "validate") && !this.$element.is(e.inputs) ? this.bind("parsleyForm", f) : this.$element.is(e.inputs) && !this.$element.is(e.excluded) ? this.bind("parsleyField", f) : this) },
            getNamespace: function(b) { return "undefined" != typeof this.$element.data("parsleyNamespace") ? this.$element.data("parsleyNamespace") : "undefined" != typeof c.get(b, "namespace") ? b.namespace : "undefined" != typeof c.get(a, "ParsleyConfig.namespace") ? a.ParsleyConfig.namespace : d.namespace },
            bind: function(b, c) {
                switch (b) {
                    case "parsleyForm":
        ...
        }, $.fn.parsley = $.fn.psly = function(a) { return new n(this, a) }, g = "function" == typeof c.get(a.ParsleyConfig, "ParsleyUI") ? (new a.ParsleyConfig.ParsleyUI).listen() : (new g).listen(), "undefined" == typeof a.ParsleyExtend && (a.ParsleyExtend = {}), "undefined" == typeof a.ParsleyConfig && (a.ParsleyConfig = {}), a.Parsley = a.psly = n, a.ParsleyUtils = c, a.ParsleyValidator = new f(a.ParsleyConfig.validators, a.ParsleyConfig.i18n), !1 !== c.get(a, "ParsleyConfig.autoBind") && $(document).ready(function() { $("[data-parsley-validate]").each(function() { new n(this) }) })
    }(window);