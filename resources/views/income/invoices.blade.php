...
<select id="filter_type" name="filter_type" class="inputbox" size="1" onchange="submitform( );" style="display: none;">
...
<div class="status">
<select id="actual_amount_status" name="actual_amount_status" class="inputbox" size="1" onchange="submitform( );" style="display: none;">
