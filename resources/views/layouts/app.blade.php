                    ...
                    <nav class="navbar navbar-default megamenu">
                        ...
                        <div id="defaultmenu" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a href="#" data-toggle="dropdown" class="dropdown-toggle"> Income <b class="caret"></b></a>
                                    <ul class="dropdown-menu" role="menu">
                                    @if(Auth::user()->hasPermissionTo('Supper Permission'))
                                ...
                                <li class="dropdown">
                                    <a href="#" data-toggle="dropdown" class="dropdown-toggle"> Expense <b class="caret"></b></a>
                                    <ul class="dropdown-menu" role="menu">
                                    @if(Auth::user()->hasPermissionTo('Supper Permission'))
                                ...
                                <li class="dropdown">
                                    <a href="#" data-toggle="dropdown" class="dropdown-toggle"> Banking <b class="caret"></b></a>
                                    <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="dropdown">
                                    <a href="#" data-toggle="dropdown" class="dropdown-toggle"> Interactions <b class="caret"></b></a>
                                    <ul class="dropdown-menu" role="menu">
